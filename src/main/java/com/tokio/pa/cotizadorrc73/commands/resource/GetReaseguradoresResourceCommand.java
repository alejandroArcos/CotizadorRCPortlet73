...
@Component(
		...
		property = {
			...
			"mvc.command.name=/cotizadores/reaseguro/getReaseguradores"
		},
		service = MVCResourceCommand.class
	)

public class GetReaseguradoresResourceCommand extends BaseMVCResourceCommand {
	...
	protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		String nombreRamo = ParamUtil.getString(resourceRequest, "nombreRamo");
		String responseMigracionString = ParamUtil.getString(resourceRequest, "reaseguroResponse");
