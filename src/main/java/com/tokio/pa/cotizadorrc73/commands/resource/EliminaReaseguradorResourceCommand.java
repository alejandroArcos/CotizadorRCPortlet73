...
@Component(
		...
		property = {
			...
			"mvc.command.name=/cotizadores/reaseguro/eliminaReasegurador"
		},
		service = MVCResourceCommand.class
	)

public class EliminaReaseguradorResourceCommand extends BaseMVCResourceCommand {
	...
	protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		ReaseguroResponse responseReasegurador = _CMServicesReaseguro
				.eliminarReaseguradorFacultativo(cotizacion, 
						version,
						folio,
